...
import com.kevinkrueger.roadstuff.utils.EntityUtils;
import com.kevinkrueger.roadstuff.network.MessageSyncTileEntity;
import com.kevinkrueger.roadstuff.network.NetUtils;
    ...
    public void synchronize() {
        if (!world.isRemote && world instanceof ServerWorld) {
            ...
            if (compoundLast == null || !compoundLast.equals(last)) {
                ...
                EntityUtils.forEachPlayerAround(serverWorld, getPos(), 128D, playerEntity -> NetUtils.sendTo(RoadStuff.SIMPLE_CHANNEL, playerEntity, msg));
                compoundLast = last;
            }
        }
    }
