...
import com.kevinkrueger.roadstuff.tileentity.TileEntityBase;
...
public class BlockBase extends Block
{
     ...
     */
    public BlockBase setToolTipp(String text)
    {
        if(text != null)
     ...
     */
    public BlockBase setToolTipp(String text, TextFormatting color)
    {
        //###############
        // Color
        //###############
